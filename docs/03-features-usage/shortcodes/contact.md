---
title: Contact form
description: Usage guide and technical reference for the Contact Form module.
sidebar_position: 10
---
![Version](https://img.shields.io/badge/version-4.27.2-blue?style=flat-square) ![Docs](https://img.shields.io/badge/docs-premium_standard-0f766e?style=flat-square) ![Updated](https://img.shields.io/badge/last%20updated-23.04.2026-orange?style=flat-square)

:::info Purpose
This page describes the Contact Form module as a standard reference, covering both technical and operational aspects.
:::
...
The Contact Form module is designed to manage and present **support** processes to visitors on the Rentiva platform.
...
You can also insert it visually from the Gutenberg block editor by selecting **"MHM Rentiva → Contact Form"**.
...
- **HTML Structure:** All containers start with the `.mhm-rentiva-contact-wrapper` class.
- **Customization:** CSS variables (`--mhm-color-primary`, etc.) are inherited from the global `css-variables.css` file.

## Section Summary
- The Contact Form page has been aligned to the standard documentation structure with consistent reference headings.
