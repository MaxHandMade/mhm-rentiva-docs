...
:::tip TEKNİK REHBER
Aşağıdaki kartlar aracılığıyla sistemin asenkron katmanları, güvenlik protokolleri ve gelecek planları hakkında detaylı teknik bilgiye ulaşabilirsiniz.
:::
...
<div className="row">
  <div className="col col--6 margin-bottom--lg">
    <div className="card padding--lg cardContainer shadow--md" style={{ height: '100%', borderTop: '4px solid #0f766e' }}>
      ...
      <a className="button button--secondary button--block" href="/mhm-rentiva-docs/docs/api/v1/rest-api">v1 Referansı</a>
    </div>
  </div>
  <div className="col col--6 margin-bottom--lg">
    <div className="card padding--lg cardContainer shadow--md" style={{ height: '100%', borderTop: '4px solid #3578e5' }}>
      ...
      <a className="button button--secondary button--block" href="/mhm-rentiva-docs/docs/api/rest-v2-planning">v2 Planı</a>
    </div>
  </div>
</div>
...
<div className="row">
  <div className="col col--6 margin-bottom--lg">
    <div className="card padding--lg cardContainer shadow--md" style={{ height: '100%', borderTop: '4px solid #e5ad24' }}>
      ...
      <a className="button button--secondary button--block" href="/mhm-rentiva-docs/docs/api/license-server-protocols">Güvenlik Detayları</a>
    </div>
  </div>
  <div className="col col--6 margin-bottom--lg">
    <div className="card padding--lg cardContainer shadow--md" style={{ height: '100%', borderTop: '4px solid #df3c29' }}>
      ...
      <a className="button button--secondary button--block" href="/mhm-rentiva-docs/docs/api/api-nervous-system">Mimari Analiz</a>
    </div>
  </div>
</div>
...
- 🛡️ [API Kimlik Doğrulama Yöntemleri](/mhm-rentiva-docs/docs/api/v1/auth-and-security)
- 🔑 [API Key Manager Kullanımı](/mhm-rentiva-docs/docs/api/v1/api-key-manager)
- 🧾 [Ödeme Geri Bildirim (Callback) API](/mhm-rentiva-docs/docs/api/v1/financial-rest-callbacks)
- 🚦 [Hata Kodları ve Rate Limiting](/mhm-rentiva-docs/docs/api/v1/rate-limits-and-errors)
