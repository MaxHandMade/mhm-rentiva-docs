...
Bu bir ana sürüm ve temmuz sonundaki 5.2.3'ten bu yana yayınlanan ilk Pro paketi. Çoğu site sahibi için iki cümle yeter: **önce MHM Rentiva'yı 6.1.3'e, sonra Pro'yu güncelleyin**; verileriniz yönetim panelini bir sonraki açışınızda kendiliğinden taşınır. Geri kalan herkes — yani Pro'nun hook'larına bağlı özel kodu olanlar — önce kısa bir listeyi okumalı, çünkü 56 hook adı değişti ve bunlardan biri ateşlemeyi bıraktığında sizi hiçbir şey uyarmıyor.
...
**Bir filtre yeniden adlandırılmadı, kaldırıldı.** `mhm_rentiva_vendor_apply_endpoint_slug` artık yok. Bayi başvuru ucunun adresi bundan böyle sitenizin diline sabitleniyor ve bir etiket değil bir tanımlayıcı olarak ele alınıyor; dolayısıyla filtrelenecek bir şey kalmadı.
