...
<div className="row">
  <div className="col col--6 margin-bottom--lg">
    <div className="card padding--lg cardContainer shadow--md" style={{ height: '100%', borderTop: '4px solid #e5ad24' }}>
      ...
      <a className="button button--secondary button--block" href="./features-usage/reading-order">Kullanım Kılavuzu</a>
    </div>
  </div>
  <div className="col col--6 margin-bottom--lg">
    <div className="card padding--lg cardContainer shadow--md" style={{ height: '100%', borderTop: '4px solid #df3c29' }}>
      ...
      <a className="button button--secondary button--block" href="./developer/reading-order">Teknik Detaylar</a>
    </div>
  </div>
</div>
