---
title: Contact form
description: Contact form modülünün kullanım kılavuzu ve teknik detayları.
sidebar_position: 10
---
...
:::info Amaç
Bu sayfa, Contact form modülü konusunu teknik ve operasyonel açıdan standart bir referans formatında açıklar.
:::
...
Contact form modülü, Rentiva platformundaki **support** süreçlerini yönetmek ve kullanıcılara sunmak için tasarlanmıştır.
...
Gutenberg blok editöründe **"MHM Rentiva -> Contact form"** bloğunu seçerek görsel olarak da ekleyebilirsiniz.
...
- **HTML Yapısı:** Tüm kapsayıcılar `.mhm-rentiva-contact-wrapper` sınıfı ile başlar.
- **Özelleştirme:** CSS değişkenleri (`--mhm-color-primary` vb.) global `css-variables.css` dosyasından miras alınır.

## Bölüm Sonu Özeti
- Contact form sayfası, tekil referans başlıklarıyla standart dokümantasyon yapısına alınmıştır.
