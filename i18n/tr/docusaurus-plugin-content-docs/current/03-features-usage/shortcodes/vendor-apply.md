...
description: Vendor application form modülünün kullanım kılavuzu ve teknik detayları.
sidebar_position: 24
---
![Version](https://img.shields.io/github/v/release/MaxHandMade/mhm-rentiva?style=flat-square&label=version&color=blue) ![Docs](https://img.shields.io/badge/docs-premium_standard-0f766e?style=flat-square) ![Updated](https://img.shields.io/github/release-date/MaxHandMade/mhm-rentiva?style=flat-square&label=last%20updated&color=orange)

:::info Amaç
Bu sayfa, Vendor application form modülü konusunu teknik ve operasyonel açıdan standart bir referans formatında açıklar.
:::
...
Vendor application form modülü, Rentiva platformundaki **vendor** süreçlerini yönetmek ve kullanıcılara sunmak için tasarlanmıştır.
...
Gutenberg blok editöründe **"MHM Rentiva -> Vendor application form"** bloğunu seçerek görsel olarak da ekleyebilirsiniz.
...
- **HTML Yapısı:** Tüm kapsayıcılar `.mhm-rentiva-vendor-apply-wrapper` sınıfı ile başlar.
- **Özelleştirme:** CSS değişkenleri (`--mhm-color-primary` vb.) global `css-variables.css` dosyasından miras alınır.

## Bölüm Sonu Özeti
- Vendor application form sayfası, tekil referans başlıklarıyla standart dokümantasyon yapısına alınmıştır.
