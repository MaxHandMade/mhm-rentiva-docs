---
title: Vehicles grid
description: Vehicles grid modülünün kullanım kılavuzu ve teknik detayları.
sidebar_position: 22
---
![Version](https://img.shields.io/github/v/release/MaxHandMade/mhm-rentiva?style=flat-square&label=version&color=blue) ![Docs](https://img.shields.io/badge/docs-premium_standard-0f766e?style=flat-square) ![Updated](https://img.shields.io/github/release-date/MaxHandMade/mhm-rentiva?style=flat-square&label=last%20updated&color=orange)

:::info Amaç
Bu sayfa, Vehicles grid modülü konusunu teknik ve operasyonel açıdan standart bir referans formatında açıklar.
:::
...
Vehicles grid modülü, Rentiva platformundaki **vehicle** süreçlerini yönetmek ve kullanıcılara sunmak için tasarlanmıştır.
...
Gutenberg blok editöründe **"MHM Rentiva -> Vehicles grid"** bloğunu seçerek görsel olarak da ekleyebilirsiniz.
...
| `columns` | `2` | Modülün **general** davranışını kontrol eder. |
...
| `show_description` | `0` | Görünürlük kontrolü. `1` (Açık) veya `0` (Kapalı). |
...
- **HTML Yapısı:** Tüm kapsayıcılar `.mhm-rentiva-vehicles-grid-wrapper` sınıfı ile başlar.
- **Özelleştirme:** CSS değişkenleri (`--mhm-color-primary` vb.) global `css-variables.css` dosyasından miras alınır.

## Bölüm Sonu Özeti
- Vehicles grid sayfası, tekil referans başlıklarıyla standart dokümantasyon yapısına alınmıştır.
