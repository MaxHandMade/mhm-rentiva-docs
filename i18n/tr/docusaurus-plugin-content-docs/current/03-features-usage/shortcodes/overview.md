...
Kısa Kod Sayfaları, MHM Rentiva'nın tüm frontend (ön yüz) fonksiyonlarını WordPress ile entegre eden mimarinin merkezidir. Sistemimizde aktif olarak görev yapan **26 adet kısa kod (shortcode)** bulunmaktadır. Bu araçları ister klasik (metin), ister sayfa oluşturucu entegrasyonlarıyla sitenizin her yerine konumlandırabilirsiniz.

---

## 🏗️ Gutenberg Blokları ve Elementor Desteği

MHM Rentiva, modern WordPress mimarisini benimsemektedir. Bu nedenle burada yer alan **26 listelenmiş kısa kod**, arka planda standart bir "Render Çıktısı" oluşturur.
...
## 📋 Aktif 26 Kısa Kod ve Kullanımları
...
### Bölüm Özeti
- **26 Kısa Kod:** Projenizin rezervasyondan b2b'ye her noktasını içerir.
