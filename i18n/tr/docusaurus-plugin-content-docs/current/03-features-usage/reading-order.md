...
<div className="row">
  <div className="col col--6 margin-bottom--lg">
    <div className="card padding--lg cardContainer shadow--md" style={{ height: '100%', borderTop: '4px solid #0f766e' }}>
      ...
      <Link className="button button--secondary button--block" to="/docs/features-usage/vehicles">Araç Yönetimi</Link>
    </div>
  </div>
  <div className="col col--6 margin-bottom--lg">
    <div className="card padding--lg cardContainer shadow--md" style={{ height: '100%', borderTop: '4px solid #3578e5' }}>
      ...
      <Link className="button button--secondary button--block" to="/docs/features-usage/bookings">Rezervasyonlar</Link>
    </div>
  </div>
</div>
...
<div className="row">
  <div className="col col--6 margin-bottom--lg">
    <div className="card padding--lg cardContainer shadow--md" style={{ height: '100%', borderTop: '4px solid #e5ad24' }}>
      ...
      <Link className="button button--secondary button--block" to="/docs/features-usage/additional-services-usage">Ekstra Hizmetler</Link>
    </div>
  </div>
  <div className="col col--6 margin-bottom--lg">
    <div className="card padding--lg cardContainer shadow--md" style={{ height: '100%', borderTop: '4px solid #df3c29' }}>
      ...
      <Link className="button button--secondary button--block" to="/docs/features-usage/customers">Müşteri Yönetimi</Link>
    </div>
  </div>
</div>
...
<div className="row">
  <div className="col col--12 margin-bottom--lg">
    <div className="card padding--lg cardContainer shadow--md" style={{ height: '100%', borderTop: '4px solid #8b5cf6' }}>
      ...
      <Link className="button button--secondary button--block" to="/docs/features-usage/reports">Raporlar ve Export</Link>
    </div>
  </div>
</div>
