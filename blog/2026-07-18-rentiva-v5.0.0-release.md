...
title: "Rentiva v5.0.0 — First Public Release"
authors: [maxhandmade]
tags: [release, rentiva, wordpress-org, compliance, major]
date: 2026-07-18T14:00
---

MHM Rentiva's first public release, free to download: the complete rental core with no artificial limits, no third-party requests, and full WordPress.org coding-standards compliance.
...
- **First public release, free to download.** Fleet management, availability, bookings, customers, WooCommerce payments, email notifications and the customer account pages — with no vehicle, booking or listing caps, no feature timers and no locked screens.
...
First public release — if you are upgrading from a pre-release build, no action is required.
